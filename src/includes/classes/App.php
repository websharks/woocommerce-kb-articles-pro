    ...
    public function __construct(array $instance = [])
    {
        $instance_base = [
            '©di' => [
                '©default_rule' => [
                    'new_instances' => [
                        Classes\Widgets\Meta::class,
                        Classes\Widgets\Search::class,
                        Classes\Widgets\Product::class,
                        Classes\Widgets\Authors::class,
                        Classes\Widgets\Categories::class,
                    ],
                ],
            ],
